...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(e.currentTarget.getAttribute('data-pizza'));
    console.log(pizza);
    updateCart(pizza);
  });
});
...
// the order id is unique so we can use it as the name of the room
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtimepizza_pp"] = self["webpackChunkrealtimepizza_pp"] || [];
